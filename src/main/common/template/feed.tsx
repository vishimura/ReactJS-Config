...
export default class CalendarFeed extends React.Component<ICalendarInlineExampleProps, ICalendarInlineExampleState> {
  ...
  private _onSelectDate(date: Date | any, dateRangeArray: Date[]|any): void {
    this.setState((prevState: ICalendarInlineExampleState) => {
      return {
        selectedDate: date,
